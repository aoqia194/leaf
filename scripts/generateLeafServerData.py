...
INDEXES_DIR = SCRIPT_DIR.parent.joinpath("serverIndexes", "common")
MANIFESTS_DIR = SCRIPT_DIR.parent.joinpath("serverManifests", "common")
...
def main():
    ...
    manifest_data_table = {
        ...
        "url": f"https://github.com/aoqia194/leaf/raw/refs/heads/main/serverIndexes/common/{manifest_version}.json",
    }
