...
INDEXES_DIR = SCRIPT_DIR.parent.joinpath("indexes", "win")
MANIFESTS_DIR = SCRIPT_DIR.parent.joinpath("manifests", "win")
...
def main():
    ...
    manifest_data_table = {
        ...
        "url": f"https://github.com/aoqia194/leaf/raw/refs/heads/main/indexes/win/{manifest_version}.json",
    }
